...
class PartyTestsDatabase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        app.config['TESTING'] = True
        app.config['SOVERYSECRETIVE'] = 'key'
        self.client = app.test_client()
    ...
    def test_games(self):
        ...
        # Ln 68 relies on the sess['RSVP] created in the setUp
        
        #test_games relies on the function games() in party.py
        #because games() checks for the key RSVP in session to pass to setUp
        #test_games will run because session = True
